var s = null,
  ...
  Css3clickchart = {
    ...
    init: function () {
      ...
      //s.edh2.insertAdjacentHTML('afterend', myCodeSelectBtn);
    ...
    doHash: function () {
      ...
      this.doAjax(s.path + s.featureURL + '/title.php', s.featureTitle);
      this.doAjax(s.path + s.featureURL + '/description.php', s.description);
      this.doAjax(s.path + s.featureURL + '/code.php', s.code);
      ...
      // }),
      this.doAjax(s.path + s.featureURL + '/result.php', s.result);
      this.doAjax(s.path + s.featureURL + '/result.php', s.result);
      ...
      //s.support.load(s.pathRoot + '/support-widget.php?url=' + s.featureURL),
      this.doAjax(s.path + s.featureURL + '/technical.php', s.info);
      this.doAjax(s.path + s.featureURL + '/polyfills.php', s.polyfills, function () {
        if (!s.polyfills.innerHTML) {
          s.polyfills.innerHTML = 'No sources yet';
        }
      });
      this.doAjax(s.path + s.featureURL + '/tutorials.php', s.tutorials, function () {
