...
var browsers = ['ios_saf', 'android', 'and_chr', 'op_mob', 'and_ff', 'and_uc'];
...
for (var i = periods.length - 1; i > -1; i--) {
  ...
  var tableCells = '<td class="ios_saf"></td><td class="android"></td><td class="and_chr"></td><td class="op_mob"></td><td class="and_ff"></td><td class="and_uc"></td>';
